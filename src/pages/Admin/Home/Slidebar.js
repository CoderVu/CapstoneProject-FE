  ...
  return (
    <>
      ...
      <div className="flex w-full">
        <aside className={`fixed top-0 left-0 z-40 w-64 h-full pt-20 transition-transform ${isOpen ? 'translate-x-0' : '-translate-x-full'} bg-white border-r border-gray-200 dark:bg-gray-800 dark:border-gray-700 sm:translate-x-0`}>
            ...
            <ul className="space-y-2 font-medium">
              ...
              <li>
                ...
                >
                  ...
                  <span className="ml-3">Manager Product</span>
                </NavLink>
              </li>
              <li>
                <NavLink
