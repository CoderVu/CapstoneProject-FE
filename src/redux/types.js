...
const types = {
    ...
    FILTER_PRODUCTS_LOCAL: "FILTER_PRODUCTS_LOCAL",
    ...
    // Home Sections
    FETCH_NEW_ARRIVALS_REQUEST: "FETCH_NEW_ARRIVALS_REQUEST",
    FETCH_NEW_ARRIVALS_SUCCESS: "FETCH_NEW_ARRIVALS_SUCCESS", 
    FETCH_NEW_ARRIVALS_ERROR: "FETCH_NEW_ARRIVALS_ERROR",

    FETCH_BEST_SELLERS_REQUEST: "FETCH_BEST_SELLERS_REQUEST",
    FETCH_BEST_SELLERS_SUCCESS: "FETCH_BEST_SELLERS_SUCCESS",
    FETCH_BEST_SELLERS_ERROR: "FETCH_BEST_SELLERS_ERROR",

    FETCH_VIEWED_PRODUCTS_REQUEST: "FETCH_VIEWED_PRODUCTS_REQUEST",
    FETCH_VIEWED_PRODUCTS_SUCCESS: "FETCH_VIEWED_PRODUCTS_SUCCESS",
    FETCH_VIEWED_PRODUCTS_ERROR: "FETCH_VIEWED_PRODUCTS_ERROR",

    // Register Staff
    REGISTER_STAFF_REQUEST: "REGISTER_STAFF_REQUEST",
    REGISTER_STAFF_SUCCESS: "REGISTER_STAFF_SUCCESS",
    REGISTER_STAFF_ERROR: "REGISTER_STAFF_ERROR",
};
